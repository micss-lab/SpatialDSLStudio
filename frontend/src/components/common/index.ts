...
export { default as RoleIndicator, PermissionGate } from './RoleIndicator';
export { default as CreatedBy, resolveOwnerEmail } from './CreatedBy';
export type { ResourceOwnership } from './CreatedBy';
