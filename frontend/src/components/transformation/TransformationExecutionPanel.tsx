        ...
        if (success) {
          ...
          if (updatedExecution) {
            ...
            if (updatedExecution.stepResults) {
              ...
              console.log('Transformation steps:', updatedExecution.stepResults.map((step: any) => ({
                ruleId: step.ruleId,
...
// Download the current execution configuration as JSON
  ...
  const executeNextStep = () => {
    ...
    // Apply the rule
    const result = transformationService.applyRule(nextRuleId, modelId, {} as PatternMatch);
